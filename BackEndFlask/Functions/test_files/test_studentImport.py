...
def test_students_imported_via_separate_files_all_in_course(flask_app_mock):
    with flask_app_mock.app_context():
        dir = os.getcwd() + os.path.join(os.path.sep, "Functions") + os.path.join(os.path.sep, "sample_files") + os.path.join(os.path.sep, "Valid.csv")
        dir2 = os.getcwd() + os.path.join(os.path.sep, "Functions") + os.path.join(os.path.sep, "sample_files") + os.path.join(os.path.sep, "Valid2.csv")
        create_testcourse(False)
        studentcsvToDB(dir, 1, 1)
...
def test_invalid_inserts_no_students_in_table(flask_app_mock):
    with flask_app_mock.app_context():
        dir = os.getcwd() + os.path.join(os.path.sep, "Functions") + os.path.join(os.path.sep, "sample_files") + os.path.join(os.path.sep, "Invalid.csv")
        create_testcourse(False)  
        studentcsvToDB(dir, 1, 1)
...
def test_WrongFormat(flask_app_mock):
    with flask_app_mock.app_context():
        dir = os.getcwd() + os.path.join(os.path.sep, "Functions") + os.path.join(os.path.sep, "sample_files") + os.path.join(os.path.sep, "WrongFormat.csv")
        create_testcourse(False)
...
def test_WrongFileType(flask_app_mock):
    with flask_app_mock.app_context():
        dir = os.getcwd() + os.path.join(os.path.sep, "Functions") + os.path.join(os.path.sep, "sample_files") + os.path.join(os.path.sep, "WrongFileType.pdf")
        create_testcourse(False)
...
def test_WrongFileTypeExcel(flask_app_mock):
    with flask_app_mock.app_context():
        dir = os.getcwd() + os.path.join(os.path.sep, "Functions") + os.path.join(os.path.sep, "sample_files") + os.path.join(os.path.sep, "ExcelFile.xlsx")
        create_testcourse(False)
        assert studentcsvToDB(dir, 1, 1) == "Wrong filetype submitted! Please submit a .csv file."

def test_TooManyColumns(flask_app_mock):
    with flask_app_mock.app_context():
        dir = os.getcwd() + os.path.join(os.path.sep, "Functions") + os.path.join(os.path.sep, "sample_files") + os.path.join(os.path.sep, "TooManyCol.csv")
        create_testcourse(False)
...
def test_FileNotFound(flask_app_mock):
    with flask_app_mock.app_context():
        dir = os.getcwd() + os.path.join(os.path.sep, "Functions") + os.path.join(os.path.sep, "sample_files") + os.path.join(os.path.sep, "NonExistentFile.csv")
        create_testcourse(False)
