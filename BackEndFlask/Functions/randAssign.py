...
from models.user import get_user_consent
    ...
    try:
        ...
        if course_uses_tas is False: 
            ...
            if tasList:
                ...
                raise NoTAsListed
        team_user_assignments = assignUsersToTeams(consentingStudentIDs, nonconsentingStudentIDs, teamIDs, team_size)
