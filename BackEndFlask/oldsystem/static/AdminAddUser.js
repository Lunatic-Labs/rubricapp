    ...
    render() {
        ...
        return (
            <React.Fragment>
                    { error &&
                            <React.Fragment>
                                <h1 className="text-danger">Creating a new users resulted in an error: { error.message }</h1>
                            </React.Fragment>
                    }
                    { errorMessage &&
                            <React.Fragment>
                                <h1 className="text-danger">Creating a new users resulted in an error: { errorMessage }</h1>
                            </React.Fragment>
                    }
