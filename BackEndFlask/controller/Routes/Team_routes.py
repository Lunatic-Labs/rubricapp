...
def update_team_user_by_edit():
    ...
    try:
        ...
        existing_user_ids = set(
            [team_user.user_id for team_user in all_team_users_in_team])
        users_to_remove = [
            team_user.user_id for team_user in all_team_users_in_team if team_user.user_id not in addedUsers]
