...
def get_all_assessment_tasks():
    if(request.args and request.args.get("user_id")):
        ...
        if type(user)==type(""):
            print(f"[Assessment_task_routes /assessment_task?user_id=<int:id> GET] An error occurred retrieving user_id: {user_id}, ", user)
    ...
    if(request.args and request.args.get("role_id")):
        ...
        if type(role)==type(""):
            print(f"[Assessment_task_routes /assessment_task?role_id=<int:id> GET] An error occurred retrieving role_id: {role_id}, ", role)
    ...
    if(request.args and request.args.get("team_id")):
        ...
        if type(team)==type(""):
            print(f"[Assessment_task_routes /assessment_task?team_id=<int:id> GET] An error occurred retrieving team_id: {team_id}, ", team)
        ...
        if type(team_assessment_tasks)==type(""):
            print(f"[Assessment_task_routes /assessment_task?team_id=<int:id> GET] An error occurred retrieving all assessment tasks assigned to team_id: {team_id}, ", team_assessment_task)
