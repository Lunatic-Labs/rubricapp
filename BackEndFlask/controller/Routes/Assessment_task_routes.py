...
def student_get_AT(id):
    #student_AT = get_role(get_user(get_user_course(get_course(get_assessment_task(id))))) - not needed
...
def TA_Instructor_get_AT(id):
    #TA_Instructor_AT = get_role(get_user(get_user_course(get_course(get_assessment_task(id))))) - not needed
