import sys
sys.path.append('..')
from BackEndFlask.functions import select_index_by_group_eva_owner
...
class select_index_by_group_eva_owner_Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_H_index2_group_(self):
        student_file_worksheet = select_index_by_group_eva_owner_Tests.setup()
