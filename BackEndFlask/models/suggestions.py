...
def get_suggestion_per_rubric(rubric_id):
    suggestion_per_rubric = SuggestionsForImprovement.query.filter_by(rubric_id=rubric_id)
    return suggestion_per_rubric
