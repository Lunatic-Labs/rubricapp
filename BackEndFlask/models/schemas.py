...
class User(db.Model):
    ...
    password = db.Column(db.String(20), nullable=False)           # password has been changed from 'text to 'string', and now has a 20 character limit.
    ...
    reset_code = db.Column(db.String(6), nullable=True)          # reset_code has been changed from 'text to 'string', and now has a 6 character limit.
