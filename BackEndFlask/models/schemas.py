...
"""
    ...
    Users(user_id, first_name, last_name, email, password, lms_id, consent, owner_id, has_set_password, reset_code, is_admin)
...
class Rubric(db.Model):
    ...
    rubric_id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    rubric_name = db.Column(db.Text)
    rubric_description = db.Column(db.Text(1000), nullable=True)
...
class Rating(db.Model):
    ...
    rating_description = db.Column(db.Text, nullable=False)
...
class ObservableCharacteristic(db.Model):
    ...
    observable_characteristics_id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    rubric_id = db.Column(db.Integer, ForeignKey(Rubric.rubric_id), nullable=False)
    category_id = db.Column(db.Integer, ForeignKey(Category.category_id), nullable=False)
    observable_characteristic_text = db.Column(db.Text, nullable=False)
