...
<div id="outside">
                ...
                <div class="d-flex flex-row justify-content-between">
                        <div class="w-25 p-2 justify-content-between" style={{}}>
                            <label id="createdByLabel">Created By</label></div>
                ...
                <div class="d-flex flex-row justify-content-between">
                        <div class="w-25 p-2 justify-content-between" style={{}}>
                            <label id="dateCreatedLabel">Date Created</label></div>
                        <div class="w-75 p-2 justify-content-around" style={{ maxWidth:"100%"}}>
                        currentDate</div>
                    </div></div>
                ...
                <div class="d-flex flex-column">
                    <div class="d-flex flex-row justify-content-between">
                        <div class="w-25 p-2 justify-content-between" style={{}}>
                            <label id="taskNameLabel">Task Name</label></div>
                        <div class="w-75 p-2 justify-content-around" style={{ maxWidth:"100%"}}>
                            <input type="text" id="taskName" name="newTaskName" className="m-1 fs-6" style={{}} placeholder="Task Name" required/></div>
                    </div></div>
                ...
                <div class="d-flex flex-column">
                    <div class="d-flex flex-row justify-content-between">
                        <div class="w-25 p-2 justify-content-between">
                            <label id="taskTypeLabel">Task Type</label></div>
                        <div class="w-75 p-2 justify-content-around ">
                        <Select options={taskType} /></div>
                </div></div>

                <div class="d-flex flex-column">
                    <div class="d-flex flex-row justify-content-between">
                        <div class="w-20 p-2 justify-content-between">
                            <label id="dueDate">Due Date</label></div>
                        <div class="w-30 p-2 justify-content-around ">
                        <input type="text" id="dueDate" name="newDueDate" className="m-1 fs-6" style={{width:"100%"}} placeholder="mm/dd/yyyy" required/></div>
                        <div class="w-20 p-2 justify-content-between">
                            <label id="courseNumberLabel">Course Number</label></div>
                        <div class="w-30 p-2 justify-content-around ">
                        <Select options={courseNumber} /></div>
                </div></div>
