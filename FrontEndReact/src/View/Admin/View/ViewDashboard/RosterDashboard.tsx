...
interface RosterDashboardState{
    isSwitchingToStudent : boolean;
}
                        ...
                        <Button
                            ...
                            onClick={async () => { // STUDENT VIEW BUTTON
                                ...
                                try {
                                    ...
                                    // Temp lamda while typing in ts gets fixed for this file.
                                    const getErrorMsg = (error:unknown):string => {
                                        return error instanceof Error ? error.message : "Issue withing lamda function to swap back to normal view."
                                    }

                                    alert(`Failed to switch to student view: ${getErrorMsg(error)}`);
                                }
                            }}
