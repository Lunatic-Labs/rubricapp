    ...
    this.getStatusIcon = () => {
      ...
      switch (status) {
        case StatusIndicatorState.NOT_STARTED:
          return (
            <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16" style={{ color: "gray", marginLeft: "4px" }}>
              <circle cx="8" cy="8" r="7" stroke="currentColor" strokeWidth="2" fill="none"/>
            </svg>
          );
        case StatusIndicatorState.IN_PROGRESS:
          return (
            <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16" style={{ color: "orange", marginLeft: "4px" }}>
              <circle cx="8" cy="8" r="7" stroke="currentColor" strokeWidth="2" fill="none"/>
        ...
        case StatusIndicatorState.COMPLETED:
          return (
            <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16" style={{ color: "green", marginLeft: "4px" }}>
              <circle cx="8" cy="8" r="7" stroke="currentColor" strokeWidth="2" fill="none"/>
