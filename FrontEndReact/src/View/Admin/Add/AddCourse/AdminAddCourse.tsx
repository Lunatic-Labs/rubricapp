...
class AdminAddCourse extends Component<AdminAddCourseProps, AdminAddCourseState> {
    constructor(props: AdminAddCourseProps) {
        super(props);
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                {validMessage !== "" && (
                    <ErrorMessage errorMessage={validMessage} />
                )}
