//This file is the primary file for nagivating around the program
    ...
    render() {
        ...
        return (
            <>
                ...
                {/*We use "this.state.activeTab" to determine what should be displayed on a per tab basis.
                Additionally, any create, save, clear, and cancel buttons are found in these sections.
                If an additional page needs to be created, it will be imported at the beginning of this file
                and
                */}
