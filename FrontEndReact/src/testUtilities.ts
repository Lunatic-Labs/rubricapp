...
// data-testid based selectors (replacement for the aria-label based helpers above,
// which used aria-label as a test hook rather than for genuine accessibility purposes)
